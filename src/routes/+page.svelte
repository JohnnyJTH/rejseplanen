<script>
	...
	const filterStations = () => {
		...
		stations = storageArr.slice(0, 11);
	};
...
<div class="container mx-auto">
	<form autocomplete="off" on:submit|preventDefault={submitValue}>
		<div class="relative">
			...
			<input type="search" id="station-input" bind:value={inputValue} on:input={filterStations} class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for a station" required />
			<button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">See departures</button>
		</div>
	</form>
	...
	<div class="w-full max-w-md mt-10 bg-white border rounded-lg shadow-md p-4 md:p-8">
